...
@Component({
  selector: 'app-eleve-header',
  templateUrl: './eleve-header.component.html',
  styleUrls: ['./eleve-header.component.scss'],
  standalone: true,
...
export class EleveHeaderComponent extends HeaderComponent {
  ...
  public newStatus = [
    { id: 0, title: 'kane', value: 25, color: 'info', details: '348 Processes. 1/4 Cores.' },
  ...
  public newTasks = [
    { id: 0, title: 'mouha', value: 0, color: 'info' },
