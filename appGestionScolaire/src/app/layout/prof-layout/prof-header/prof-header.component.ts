...
@Component({
  selector: 'app-prof-header',
  templateUrl: './prof-header.component.html',
  styleUrls: ['./prof-header.component.scss'],
  standalone: true,
...
export class ProfHeaderComponent extends HeaderComponent {
